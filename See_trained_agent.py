...
def main():
    ...
    if PRE_TRAINED == True:
        ...
        trained_checkpoint = r'E:\Ivan\UPC\GitHub\logs\062321_121635\model_dir\episode-399992.pt' #First test with LS with one agent and one landmark (episode_length=35) In this case, the observation state is the estimated landmark position instead of the true landmark position as the two previous tests. In addition, I implemented a LSTM, run 3 with some tweaks, it doesn't work.
