...
SEED = 19221438   #198                # Seed for random numbers
BENCHMARK   =   True
...
def main():
    ...
    if PRE_TRAINED == True:
        ...
        trained_checkpoint = r'E:\Ivan\UPC\GitHub\logs\090321_092533\model_dir\episode-450000.pt' #Test 40. first test with LS with one agent and one landmark (episode_length=35) This works better.
